 ...
 */
abstract class Multa implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\MultaTableMap';
    ...
    /**
     * Initializes internal state of Base\Multa object.
     */
    ...
    /**
     * Compares this with another <code>Multa</code> instance.  If
     * <code>obj</code> is an instance of <code>Multa</code>, delegates to
     * <code>equals(Multa)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Multa The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[MultaTableMap::COL_ID] = true;
        }
    ...
    public function setSocioId($v)
    {
        ...
        if ($this->socio_id !== $v) {
            $this->socio_id = $v;
            $this->modifiedColumns[MultaTableMap::COL_SOCIO_ID] = true;
        }
    ...
    public function setCantidad($v)
    {
        ...
        if ($this->cantidad !== $v) {
            $this->cantidad = $v;
            $this->modifiedColumns[MultaTableMap::COL_CANTIDAD] = true;
        }
    ...
    public function setComentario($v)
    {
        ...
        if ($this->comentario !== $v) {
            $this->comentario = $v;
            $this->modifiedColumns[MultaTableMap::COL_COMENTARIO] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[MultaTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[MultaTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildMultaQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildMultaQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(MultaTableMap::COL_CREATED_AT)) {
                    $this->setCreatedAt($highPrecision);
                }
                if (!$this->isColumnModified(MultaTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt($highPrecision);
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(MultaTableMap::COL_UPDATED_AT)) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                MultaTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[MultaTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . MultaTableMap::COL_ID . ')');
        }
        ...
        if ($this->isColumnModified(MultaTableMap::COL_CANTIDAD)) {
            $modifiedColumns[':p' . $index++]  = 'cantidad';
        }
        if ($this->isColumnModified(MultaTableMap::COL_COMENTARIO)) {
    ...
    {
        $pos = MultaTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Multa'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Multa'][$this->hashCode()] = true;
    ...
    {
        $criteria = new Criteria(MultaTableMap::DATABASE_NAME);
        ...
        if ($this->isColumnModified(MultaTableMap::COL_CANTIDAD)) {
            $criteria->add(MultaTableMap::COL_CANTIDAD, $this->cantidad);
        }
        if ($this->isColumnModified(MultaTableMap::COL_COMENTARIO)) {
            $criteria->add(MultaTableMap::COL_COMENTARIO, $this->comentario);
        }
        if ($this->isColumnModified(MultaTableMap::COL_CREATED_AT)) {
            $criteria->add(MultaTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(MultaTableMap::COL_UPDATED_AT)) {
            $criteria->add(MultaTableMap::COL_UPDATED_AT, $this->updated_at);
        }
    ...
    {
        $criteria = ChildMultaQuery::create();
        $criteria->add(MultaTableMap::COL_ID, $this->id);
    ...
    {
        return (string) $this->exportTo(MultaTableMap::DEFAULT_STRING_FORMAT);
    }
     ...
     *
     * @return     $this|ChildMulta The current object (for fluent API support)
     */
