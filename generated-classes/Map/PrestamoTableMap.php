...
class PrestamoTableMap extends TableMap
{
     ...
     */
    const COL_SOCIO_ID = 'prestamo.socio_id';

    /**
     * the column name for the cantidad field
     */
    const COL_CANTIDAD = 'prestamo.cantidad';

    /**
     * the column name for the interes field
     */
    const COL_INTERES = 'prestamo.interes';

    /**
     * the column name for the comentario field
     */
    const COL_COMENTARIO = 'prestamo.comentario';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'prestamo.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'prestamo.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'SocioId', 'Cantidad', 'Interes', 'Comentario', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('id', 'socioId', 'cantidad', 'interes', 'comentario', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(PrestamoTableMap::COL_ID, PrestamoTableMap::COL_SOCIO_ID, PrestamoTableMap::COL_CANTIDAD, PrestamoTableMap::COL_INTERES, PrestamoTableMap::COL_COMENTARIO, PrestamoTableMap::COL_CREATED_AT, PrestamoTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id', 'socio_id', 'cantidad', 'interes', 'comentario', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'SocioId' => 1, 'Cantidad' => 2, 'Interes' => 3, 'Comentario' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'socioId' => 1, 'cantidad' => 2, 'interes' => 3, 'comentario' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
        self::TYPE_COLNAME       => array(PrestamoTableMap::COL_ID => 0, PrestamoTableMap::COL_SOCIO_ID => 1, PrestamoTableMap::COL_CANTIDAD => 2, PrestamoTableMap::COL_INTERES => 3, PrestamoTableMap::COL_COMENTARIO => 4, PrestamoTableMap::COL_CREATED_AT => 5, PrestamoTableMap::COL_UPDATED_AT => 6, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'socio_id' => 1, 'cantidad' => 2, 'interes' => 3, 'comentario' => 4, 'created_at' => 5, 'updated_at' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('interes', 'Interes', 'INTEGER', true, null, null);
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PrestamoTableMap::COL_SOCIO_ID);
            $criteria->addSelectColumn(PrestamoTableMap::COL_CANTIDAD);
            $criteria->addSelectColumn(PrestamoTableMap::COL_INTERES);
            $criteria->addSelectColumn(PrestamoTableMap::COL_COMENTARIO);
            $criteria->addSelectColumn(PrestamoTableMap::COL_CREATED_AT);
            $criteria->addSelectColumn(PrestamoTableMap::COL_UPDATED_AT);
        } else {
