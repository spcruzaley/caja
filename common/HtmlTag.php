...
/*
 * @author Airmanbzh
 * @url https://github.com/Airmanbzh
 */
...
class HtmlTag extends Markup
{
    ...
    /**
     * Add custom param for a tag
     * Added by SPCruzaley Feb/2018
     *
     * @param string $param
     * @param array $value
     * @return HtmlTag instance
    ...
    {
        if (!isset($this->attributeList[$param]) || is_null($this->attributeList[$param])) {
            $this->attributeList[$param] = array();
        }
        $this->attributeList[$param][] = $value;

        return $this;
    }

    /**
     * Add custom params for a tag
     * Added by SPCruzaley Feb/2018
     *
     * @param array $param
     * @return HtmlTag instance
