            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <i class="menu-icon fa fa-users"></i>Socios</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-user"></i><a href="/socio.php/registrar">Registrar socio</a></li>
                            <li><i class="fa fa-user"></i><a href="/socio.php/consultar">Consultar socio</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="/ahorro.php/registrar"> <i class="menu-icon fa fa-usd"></i>Ahorros </a>
                    </li>
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <li>
                        <a href="widgets.html"> <i class="menu-icon ti-email"></i>Entrar </a>
                    </li>
                    <li>
                        <a href="widgets.html"> <i class="menu-icon ti-email"></i>Salir </a>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
        </nav>
